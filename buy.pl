...
#            print " rows".$count."\n";
            ...
            my $cached=$memd->get('forgebuy-'.$typeid);
...
#                  print "Total:".$numberOfBuyItems."     Five percent:   ".$fivePercent."  bought:".$bought."  Price:".$fiveAverageBuyPrice."\n";
                   $memd->set('forgebuy-'.$typeid,sprintf("%.2f",$fiveAverageBuyPrice)."|".$numberOfBuyItems."|".$fivePercent."|".$when);
            }
        }
    }
}
